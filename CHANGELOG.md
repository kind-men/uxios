...
- Environment interface and payload that can be added to the config. This will allow extra information to be associated with
  a request, reducing the need for capturing in promise lambdas.

## [0.4.2] - 2025-12-03

### Fixed

- ConsoleLogger crashes when no response object is returned, a check has been added and a new error shown when that 
  happens.
...
- Missing import statement in QueryString.cs when using a platform other than WebGL
